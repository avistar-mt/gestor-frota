...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            @include('layouts.navbars.auth.topnav', ['title' => 'Vehicle Management'])
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        @can('manage-users', auth()->user())
                            <a href="{{ route('vehicle-new') }}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add Vehicle</a>
                        @endcan
                    </div>
                            ...
                            <tbody>
                                @foreach ($vehicles as $vehicle)
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">{{ $vehicle->status }}</td>
                                            ...
                                            <span class="d-flex">
                                                @can('manage-users', auth()->user())
                                                    ...
                                                    <form action="{{ route('vehicle-destroy', $vehicle->id) }}" method="post">
                                                        @csrf
                                                        <button onclick="confirm('Are you sure you want to remove the vehicle?') || event.stopImmediatePropagation()"
