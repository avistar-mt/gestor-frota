...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            @include('layouts.navbars.auth.topnav', ['title' => 'City Management'])
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        @can('manage-users', auth()->user())
                            <a href="{{ route('city-new') }}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add City</a>
                        @endcan
                    </div>
                                            ...
                                            <span class="d-flex">
                                                @can('manage-users', auth()->user())
                                                    ...
                                                    <form action="{{ route('city-destroy', $city->id) }}" method="post">
                                                        @csrf
                                                        <button onclick="confirm('Are you sure you want to remove the city?') || event.stopImmediatePropagation()"
