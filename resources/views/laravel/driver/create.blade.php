...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl ">
    <div class="container-fluid py-1 px-3">
        @include('layouts.navbars.auth.topnav', ['title' => 'New Driver'])
                    ...
                    <form method="POST" action="{{ route('driver-new.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <div class="input-group">
                                    <input id="birth_date" name="birth_date" class="form-control datetimepicker" placeholder="DD/MM/AAAA" value="{{ old('birth_date') }}" data-input>
                                </div>
                                @error('birth_date')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                @enderror
                            ...
                            <div class="col-3">
                                ...
                                <div class="input-group">
                                    <input id="phone" name="phone" class="form-control" type="text" placeholder="phone" value="{{ old('phone') }}">
                                </div>
                                @error('phone')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                @enderror
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-3">
                                ...
                                <div class="input-group">
                                    <input id="cnh_number" name="cnh_number" class="form-control" type="text" placeholder="" value="{{ old('cnh_number') }}">
                                </div>
                                @error('cnh_number')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                @enderror
                            ...
                            <div class="col-3">
                                ...
                                <div class="input-group">
                                    <input id="cnh_due_date" name="cnh_due_date" class="form-control datetimepicker" placeholder="DD/MM/AAAA" type="date" value="{{ old('cnh_due_date')}}" data-input>
                                </div>
                                @error('cnh_due_date')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                @enderror
                        ...
                        <div class="row mt-4">
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input id="street" name="street" class="form-control" type="text" placeholder="Street" value="{{ old('street')}}">
                                </div>
                                @error('street')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                @enderror
                            ...
                            <div class="col-2">
                                ...
                                <div class="input-group">
                                    <input id="number" name="number" class="form-control" type="text" placeholder="Number" value="{{ old('number') }}">
                                </div>
                                @error('number')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                @enderror
                            ...
                            <div class="col-3">
                                ...
                                <div class="input-group">
                                    <input id="city" name="city" class="form-control" type="text" placeholder="City" value="{{ old('city') }}">
                                </div>
                                @error('city')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                @enderror
                            ...
                            <div class="col-3">
                                ...
                                <div class="input-group">
                                    <input id="state" name="state" class="form-control" type="text" placeholder="state" value="{{ old('state') }}">
                                </div>
                                @error('state')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                @enderror
                        ...
                        <div class="row mt-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="status" name="status" value="{{ old('status') ? 'active' : 'inactive' }}">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <a href="{{ route('driver-management') }}" class="btn btn-light m-0">Back</a>
