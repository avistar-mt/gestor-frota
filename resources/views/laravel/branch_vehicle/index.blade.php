...
<nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
    ...
    <div class="container-fluid py-1 px-3">
        @include('layouts.navbars.auth.topnav', ['title' => 'Branch Vehicle'])
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between">
                    <h5 class="mb-0">Branch Vehicle</h5>
                    @can('manage-users', auth()->user())
                    <a href="{{ route('branch-vehicle-new') }}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add
                        Branch Vehicle</a>
                    @endcan
                </div>
                                ...
                                <td class="text-sm">
                                    <span class="d-flex">
                                        ...
                                        <form action="{{ route('branch-vehicle-destroy', $branchVehicle->id) }}"
                                            ...
                                            @csrf
                                            <button
                                                onclick="confirm('Are you sure you want to remove the Branch Vehicle?') || event.stopImmediatePropagation()"
