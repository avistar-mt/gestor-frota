...
<nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur" data-scroll="false">
    <div class="container-fluid py-1 px-3">
        @include('layouts.navbars.auth.topnav', ['title' => 'New Branch Vehicle'])
    ...
    <div class="row mb-5">
        <div class="col-lg-9 col-12 mx-auto">
            <div class="card card-body mt-4">
                <h6 class="mb-0">New Branch Vehicle</h6>
                <hr class="horizontal dark my-3">
                <form method="POST" action="{{ route('branch-vehicle-new.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="mb-3">
                                <select class="form-select" id="choices-branch" name="branch">
                        ...
                        <div class="col">
                            ...
                            <div class="mb-3">
                                <select class="form-select" id="choices-vehicles" name="vehicles[]" multiple>
