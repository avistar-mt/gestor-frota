    ...
    <div class="row mb-5">
        <div class="col-lg-9 col-12 mx-auto">
            <div class="card card-body mt-4">
                ...
                <form method="PUT" action="{{ route('reservation-edit.update', $reservation->id) }}">
                    @csrf
                    ...
                    <div class=" d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" name="status" value="accept" class="btn btn-success m-0 ms-2">Approve</button>
